		...
		return (
			<div className="choose-file">
				<form action="#">
					...
					<div
						className={`p-4 bg-gray-100 my-5 w-11/12 m-auto border-solid border border-gray-900 border-opacity-50 rounded-md choose-file-disabled ${selectedFile === null ? "display-none" : ""
							}`}
					>
